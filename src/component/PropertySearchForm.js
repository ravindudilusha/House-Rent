    ...
    <div className="property-search-form">
      ...
      <div className="row">
        ...
        <div className="col">
          ...
          <input className="input" type="number" min="0" value={minBedrooms} onChange={(e) => setMinBedrooms(e.target.value)} />
        </div>
      </div>
      ...
      <div className="row">
        <div className="col">
          ...
          <input className="input" type="number" min="0" value={maxBedrooms} onChange={(e) => setMaxBedrooms(e.target.value)} />
        </div>
